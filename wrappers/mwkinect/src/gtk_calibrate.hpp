...
class mwkinect_calibrate_gui: public Gtk::Window {
public:
    mwkinect_calibrate_gui(thread_com * com);
    ~mwkinect_calibrate_gui();
...
void * mwkinect_calibrate_gui_thread_start(void * ptr_to_gui_ptr);
